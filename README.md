...
<p align="center">
  대시보드를 <b>만드는</b> 일에서 시작해, 그 아래 <b>데이터 파이프라인</b>과 그 위 <b>AI 에이전트</b>까지 넓혀가는 중입니다.
</p>
...
**MILVUS** DX2본부 2팀에서 Tableau 기반 데이터 시각화 컨설팅을 하고 있습니다.<br>
전자·제조·미디어·금융·유통·비영리 등 여러 산업에서 대시보드 기획부터 구축·운영까지 담당하고,<br>
고객사 교육과 POC 설계를 함께 맡고 있습니다.

**단순 기능 설명보다 활용 사례 중심의 교육**을 지향합니다.<br>
"쉽고 재미있게"를 컨셉으로, 도구를 쓰고 싶어지게 만드는 쪽에 관심이 많습니다.

최근에는 BI 앞단의 **데이터 엔지니어링**과 **AI 에이전트** 영역으로 범위를 넓히고 있습니다.
